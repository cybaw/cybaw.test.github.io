...
function setup() {
	...
	var title1 = createDiv("<a href='./bio.html'>Bio</a><style>a {text-align:center;font-size:36px;font-family: impact;vertical-align:middle;text-decoration:none; color:black;}</style>");
	title1.position(width/4*1, height/2);
	var title2 = createDiv("<a href='./assignment.html'>Assignment</a><style>a {text-align:center;font-size:36px;font-family: impact;vertical-align:middle;text-decoration:none; color:black;}</style>");
	title2.position(width/4*2+10 , height/2);
	
	var title3 = createDiv("<a href='./finalProject.html'>Final Project</a><style>a {text-align:center;font-size:36px;font-family: impact;vertical-align:middle;text-decoration:none; color:black;}</style>");
